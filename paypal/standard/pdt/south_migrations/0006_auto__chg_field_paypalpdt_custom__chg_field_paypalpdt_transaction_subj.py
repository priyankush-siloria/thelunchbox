...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PayPalPDT.custom'
        db.alter_column(u'paypal_pdt', 'custom', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'PayPalPDT.transaction_subject'
        db.alter_column(u'paypal_pdt', 'transaction_subject', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'PayPalPDT.custom'
        db.alter_column(u'paypal_pdt', 'custom', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PayPalPDT.transaction_subject'
        db.alter_column(u'paypal_pdt', 'transaction_subject', self.gf('django.db.models.fields.CharField')(max_length=255))
